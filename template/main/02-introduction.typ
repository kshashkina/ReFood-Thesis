...
In this era of rapid digital transformation, consumers face a paradoxical problem: although technology simplifies access to information, the process of choosing products in the supermarket that truly align with the principles of a healthy lifestyle and environmental responsibility remains extremely fragmented. As global food production volumes grow, deceptive marketing tactics and complex ingredient formulas inevitably obscure the transparency of product information. Modern consumers spend far too much time deciphering the fine print on labels and ambiguous processing symbols. Despite advances in generative artificial intelligence, universal chatbots remain too general and require lengthy text queries to be accurate. This calls for an intelligent, integrated personal assistant that can instantly interpret product data and provide immediate, practical recommendations on both nutrition and sustainable waste management.

Unlike existing similar apps, which typically prioritize only one isolated function (such as purely counting a product's calories or providing general reference information about packaging), ReFood addresses the lack of a comprehensive platform that combines in-depth nutritional analysis with powerful geolocation and AI features available in both English and Ukrainian languages. The app combines elements of an interactive scanner with the analytical depth of artificial intelligence and the convenience of mapping services, allowing users to identify products by barcode, view ingredient lists translated into plain language without marketing jargon, identify the type of packaging material and plan optimal routes to the nearest recycling collection points.

This paper describes the journey of two software engineering students who, over an intensive three-month development period, transformed a conceptual solution into a fully functional mobile application ready for production deployment on the Apple App Store. The development process included detailed research of the FoodTech market, competitor analysis, the design of architectural solutions and the implementation of a scalable cloud system using modern software engineering practices.
...
6. To build a scalable architecture capable of supporting growth in both users and processed data.
7. To deploy a backend infrastructure using the AWS cloud and complete the deployment pipeline for the application's publication on the Apple App Store.
...
*Domain Research and Analysis* (Chapter 3) examines the current FoodTech software ecosystem based on a thorough analysis of competitors, global market research, and the identification of functional gaps that justify the need for our comprehensive solution.
